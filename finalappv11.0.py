...
def video():
    if request.method == 'POST':
        ...
        def giveallvids():
            ...
            result = re.findall(pattern, video_url, re.MULTILINE | re.IGNORECASE)
            videoid = str(result[0])
            ...
            try:
                ...
                print("No token")
                return {'haha': finaltotal, 'haha1': leona, 'haha2': deod, 'haha3': mia, 'haha4': lea}
        ...
        return render_template('video.html', query=tl, dis = td, tps = tps, tpn = tpn, ft = ft)
